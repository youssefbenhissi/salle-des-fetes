...
<body><form name="form1" method="POST" action="views/ajoutclient.php">
...
<div class="content">
  	<fieldset class ="border1">
 		...
 		<span class="resultat"></span></div>
  		...
  		<span class="resultat"></span></div>
  	   <div class="h2">
        <label class="label">active:</label><input class="controle" type="checkbox" name="active" value="1" placeholder="votre adresse">
      <span class="resultat"></span></div>
