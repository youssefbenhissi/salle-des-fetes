           ...
           <li class="sub-menu">
            ...
            <ul class="sub">
                       <li><a href="Desactivercompte.php">Desactiver un compte</a></li>
                        ...
                        <li><a  class="active" href="afficher liste client trier.php">affichage trier</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
...
$client1=new clientC();
 $listeclient1=$client1->afficherASC();
 $listeclient2=$client1->afficherDESC();

?>

<form method="POST" action="afficher liste client trier.php">
    
       
       
        
   <h1> <input type="submit" name="asc" value="ascendant"><input type="submit" name="desc" value="descendant"></h1>
