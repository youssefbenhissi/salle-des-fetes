...
if(empty($_POST['search'])==false){
    $x=$_POST['search'];
    $list=$platc->rechercherchant($x);}
else
    $list=$platc->afficherChanteur();
?>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <h5 class="centered"> Rahma chehoud</h5>
          <li class="mt">
            <a href="index.html">
          ...
          <li class="sub-menu">
            ...
            <li><a href="formulaireajout.php">ajouter chanteur</a></li>
              <li><a class="active" href="formulaireafficher.php">afficher chanteur</a></li>
      ...
      <section class="wrapper">
        <div class="row mt">
          <div class="col-lg-6 col-md-6 col-sm-12">
              ...
              <form method="POST" action="formulaireafficher.php">
                  <input type="text" id="arearech" name="search" placeholder="Taper pour rechercher ... " required>
                  <input type="submit" value="Rechercher"  class="btn btn-primary">
              </form>
              <center><h1 id="bri"><strong>la listes des chanteurs</strong></h1></center>
...
<td><a href="supp.php?id=<?php echo $p["id"];  ?>">
                                  <button class="btn btn-danger btn-xs" ><i class="fa fa-trash-o "></i></button></a></td>
                                  <td><a href="formulairemodif.php?id=<?php echo $p["id"];  ?>">
...
<h5>Nbre des chanteur:<?php echo $nbr['QTE'];; ?></h5>
                  <?php if(!empty($list)){ ?>
                      <a href="trier.php?Name=<?php echo $p["nom"]; ?>">
