        ...
        *********************************************************************************************************************************************************** -->
            ...
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li class="active">
                                <a href="afficherReclamations.php">reclamations</a>
                            </li>
                            <li>
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i> table d'avis</h3>
                <div class="row">
                    <div class="col-md-12">
                        <div class="content-panel">
                            <table border="1">
                                ...
                                <tr>
                                    ...
                                    <td><a href="modifierAvis.php?nom=<?PHP echo $row['nom']; ?>">
                                            Modifier</a></td>
                                </tr>
                            ...
                            <form method="POST" action="rechercherReclamation.php">
                                <input type="submit" name="rechercher" value="rechercher">
                                <input value="<?PHP echo $row['nom']; ?>" name="nom">
                            </form>
                            <form method="POST" action="trierAvis.php">
