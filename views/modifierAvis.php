...
<body>
    <section id="container">
        ...
        *********************************************************************************************************************************************************** -->
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li>
                                <a href="afficherAvis.php">avis</a>
                            </li>
                            <li>
        ...
        if (isset($_GET['nom'])) {
            $avisC = new AvisC();
            $result = $avisC->recupererAvis($_GET['nom']);
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i> table de reclamation</h3>
                <div class="row">
                    <div class="col-md-12">
                        <div class="content-panel">
                            <h4><i class="fa fa-angle-right"></i> table de reclamation</h4>
                            <form method="POST">
                                <table>
                                    ...
                                    <tr>
                                        <td>nombre</td>
                                        <td><input type="number" name="nombre" value="<?PHP echo $nombre ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>avis1</td>
                                        <td><input type="text" name="avis1" value="<?PHP echo $avis1 ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>avis2</td>
                                        <td><input type="text" name="avis2" value="<?PHP echo $avis2 ?>"></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                            ...
                            <a href="afficherReclamations.php">retour aux reclamations</a>
                        </div>
                    </div>
                </div>
            </section>
...
if (isset($_POST['modifier'])) {
    $avis = new Avis($_POST['nom'], $_POST['prenom'], $_POST['email'], $_POST['nombre'], $_POST['avis1'], $_POST['avis2']);
    $avisC->modifierAvis($avis, $_POST['nom_ini']);
    echo $_POST['nom_ini'];
