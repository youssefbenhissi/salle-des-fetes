...
<body>
    ...
    <div class="wrapper fixed__footer">
                                ...
                                <ul class="main__menu">
                                    ...
                                    <li class="drop"><a href="fafficherchanteurFront.php">Animation</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="faffichertroupeFront.php">troupe musicale</a></li>
                                        </ul>
                                    </li>
            ...
            <div class="shopping__cart">
                <div class="shopping__cart__inner">
                    ...
                    <ul class="shopping__btn">
                        ...
                        <li class="shp__checkout"><a href="appointement.php">Appointement</a></li>
                    </ul>
                </div>
            </div>
            <!-- End Cart Panel -->
        ...
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/rahma/y.jpg) no-repeat scroll center center / cover ;">
            <div class="ht__bradcaump__wrap">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Appointement</h2>
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" href="index.html">Home</a>
                                  <span class="brd-separetor">/</span>
                                  <span class="breadcrumb-item active">Appointement</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 col-lg-8">
                        <div class="ckeckout-left-sidebar">
                            ...
                            <div class="checkout-form">
                                <h2 class="section-title-3">Appointement</h2>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="checkout-right-sidebar">
                            <div class="our-important-note">
                                <h2 class="section-title-3">Chose the date of appointement :</h2>
                                <div class="controls">
                                <div class="single-checkout-box">
                                        <input class="controle" type="text" name="Event location"placeholder="Event location"required pattern="[a-zA-Z-\.]{3,12}">
                                        
                                    </div>
                                   
                                    <div class="single-checkout-box">
                                    <input class="controle" type="text" name="Appointement"placeholder="Appointement"required pattern="[a-zA-Z-\.]{3,12}">
                                    </div>
                                    <div class="single-checkout-box">
                                       
                                       <input  class="controle" type="date" name="Event Date"placeholder="Event Date">
