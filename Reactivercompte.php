...
<body>
  <section id="container">
          ...
          <li class="sub-menu">
           ...
           <li class="sub-menu">
            ...
            <ul class="sub">
                        ...
                        <li><a class="active" href="Reactivercompte.php">Reactiver Un compte</a></li>
   ...
   <h2 class="w3ls_head">Reactiver un compte</h2>
            <form action="views/reactivercompte.php" method="post">
                <table>
    ...
    <center> 
        ...
        <button type="submit" id="button" name="valider" value="Enovyer">DEBLOCK</button>
    </center> 
