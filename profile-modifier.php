                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-lg-8 d-none d-md-block">
                            <nav class="mainmenu__nav  d-none d-lg-block">
                                <ul class="main__menu">
                                    <li class="drop"><a href="index2.php">Home</a>
                                    </li>
                                    ...
                                    <li class="drop"><a href="#">pages</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="profile-modifier.php">login & register</a></li>
                                        </ul>
                                    </li>
                        ...
                        <div class="htc__login__register__wrap">
                            ...
                            <div id="login" role="tabpanel" class="single__tabs__panel tab-pane active">
                                ...
                                <div class="htc__login__btn mt--30">
                                    <a href="chat/chat_example.php">chat</a>
                             </div>
                             <div class="htc__login__btn mt--30">
                                    <a href="modify.php">change it</a>
                                </div>
