...
foreach ($allpacks as $p){
    ...
    $totalwithPackValue =$total-( $total * ($p['value']/100)) ;
                    ...
                    <div class="plan-inner">
                        ...
                        <div class="entry-content">
                            <ul>
                                ...
                                <li><i class="fa fa-check">  </i><strong>  <?php print_r( $p['decor']['nom']);?> : </strong><del><?php print_r( $p['decor']['prix']);?>TND</del></li>
                                <li><i class="fa fa-check">  </i><strong>  <?php print_r( $p['gastro']['nom']);?> : </strong><del><?php print_r( $p['gastro']['prix']);?>TND</del></li>
