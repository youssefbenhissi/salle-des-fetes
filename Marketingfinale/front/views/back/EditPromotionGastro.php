...
$p = $crud->afficherPromotionGastro($conn,$id);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (is_uploaded_file($_FILES['image']["tmp_name"])) {
        ...
        $promotionA = new PromotionGastro($p['id_animation'],$value,$date_debut,$date_fin,$newfilename);
    }else{
        $promotionA = new PromotionGastro($p['id_animation'],$value,$date_debut,$date_fin,$p['image']);
    }
    $crud = new PromotionGastroC();
    $crud->modifierPromotionGastro($promotionA,$id,$conn);
...
<?php include_once 'header.php'  ?>
    <h3><i class="fa fa-angle-right"></i>Modifier Promotion pour la Gastronomie </h3>
    <div class="row mt">
        <div class="col-lg-12">
