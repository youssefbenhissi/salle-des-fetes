...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $value = $_POST['value'];
    $promotionA = new PromotionAnimation($Aninmation, $value, $date_debut, $date_fin, $newfilename);
    $crud = new PromotionAnimationC();
...
<h3><i class="fa fa-angle-right"></i>Ajouter Promotion pour l'animation </h3>
<div class="row mt">
        <div class="form-panel">
            <form id="mainAddAnimationPromotion" class="form-horizontal"  method="post"  enctype="multipart/form-data" novalidate="">
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="animation">Animation</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5 input-group">
                        ...
                        <input type="file" id="file" aria-required="true"   required name="image" data-validation="mime size" data-validation-allowing="jpg, png, gif" data-validation-max-size="2M" class="default" />
                        </span>
                            </div>
                        </div>
                    </div>
