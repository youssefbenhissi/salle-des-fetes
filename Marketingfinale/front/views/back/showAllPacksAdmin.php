...
$conn=$c->cnx;
$crud = new PackC();
$packs = $crud->afficherTousPack($conn);
?>
<?php include_once 'header.php' ?>
<h3><i class="fa fa-angle-right"></i>All Packs </h3>
<a HREF="insertpack.php"><input type="submit" name="ajouter" value="Ajouter"
                                                class="btn btn-primary  col-md-12"></a>
<br>
<br>
<br>
<div class="row mb">
        ...
        <div class="">
            <table  class="display table table-bordered"
                ...
                <?php foreach ($packs as $p) { ?>
                    <tr>
                        <td class="center "><?php echo $p['nom'] ?></td>
                        <td class=""> <?php echo $p['date_debut'] ?></td>
                        <td class=""> <?php echo $p['date_fin'] ?></td>
                        <td class=""> <?php echo $p['value'] ?></td>
                        <td class="hidden-phone ">
                            <a class="" href="EditPack.php?id=<?php echo $p['id'] ?>">
                                <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
                            </a>
                            <a class="" href="deletePack.php?id=<?php echo $p['id'] ?>">
