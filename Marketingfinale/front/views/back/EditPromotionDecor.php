...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (is_uploaded_file($_FILES['image']["tmp_name"])) {
        ...
        $promotionA = new PromotionDecor($p['id_animation'],$value,$date_debut,$date_fin,$newfilename);
    }else{
        $promotionA = new PromotionDecor($p['id_animation'],$value,$date_debut,$date_fin,$p['image']);
    }
    $crud = new PromotionDecorC();
