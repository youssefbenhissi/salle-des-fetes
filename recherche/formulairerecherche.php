    ...
    <aside>
     ...
     <li><a href="formulaireajout.php">ajouter administrateur</a></li>
              ...
              <li><a href="formulaireafficher.php">afficher administrateur</a></li>
               <li><a href="formulairerecherche.php">afficher administrateur</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
...
<form method="POST" action="views/rechercheadmin.php">
<div>
...
<div>
<input type="submit" name="recherche" value="recherche" class="btn btn-primary">
