...
<body>
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
           ...
           <li class="sub-menu">
            ...
            <ul class="sub">
                       <li><a class="active" href="Desactivercompte.php">Desactiver un compte</a></li>
   ...
   <h2 class="w3ls_head">Desactiver un compte</h2>
            <form action="views/desactivercompte.php" method="post">
                <table>
    ...
    <center> 
        ...
        <input type="number" placeholder="Identifiant" required  name="identifiant">
        <button type="submit" id="button" name="valider" value="Enovyer">BLOCK</button>
    </center> 
